    ...
    def get_carbon_entries(self, start_datetime:datetime=None, end_datetime:datetime=None):
        if end_datetime is None:
            if start_datetime is None:
                entries = CarbonLog.query.filter_by(user_id=self.user_id).all()
            else:
                entries = CarbonLog.query.filter_by(sqlalchemy.and_(CarbonLog.user_id==self.user_id, CarbonLog.log_timestamp>=start_datetime))
        else:
            entries = CarbonLog.query.filter_by(sqlalchemy.and_(CarbonLog.user_id==self.user_id, CarbonLog.log_timestamp>=start_datetime, CarbonLog.log_timestamp<=end_datetime))
    ...
    def get_global_carbon_entries(start_datetime:datetime=None, end_datetime:datetime=None):
        if end_datetime is None:
            if start_datetime is None:
                ...
                entries = CarbonLog.query.filter_by(CarbonLog.log_timestamp>=start_datetime)
        else:
            entries = CarbonLog.query.filter_by(sqlalchemy.and_(CarbonLog.log_timestamp>=start_datetime, CarbonLog.log_timestamp<=end_datetime))
